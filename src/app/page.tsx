    ...
    >
      <div id="nav" data-section="nav">
        <NavbarStyleApple 
          brandName="Aajel" 
          navItems={navItems}
          logoImageSrc="https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AWxsIwZ7faFTOMvnFS8qknLwYR/uploaded-1772723192460-1v0n4pt8.png"
        />
      </div>
      ...
      <div id="hero" data-section="hero">
        <HeroBillboardDashboard
          ...
          dashboard={{
            title: "Service Excellence Dashboard",            logoIcon: Zap,
            imageSrc: "http://img.b2bpic.net/free-photo/multi-ethnic-business-team-sitting-table-office-center-speaking-about-project-meeting-broadroom_482257-5077.jpg",            searchPlaceholder: "What service do you need?",            sidebarItems: [
            ...
            stats: [
              {
                title: "Clients Served",                values: [1200, 1450, 1680],
                valueSuffix: "+",                description: "Satisfied customers yearly"},
              {
                title: "Services",                values: [7, 9, 12],
                description: "Professional service categories"},
              {
                title: "Success Rate",                values: [98, 99, 99],
                valueSuffix: "%",                description: "Customer satisfaction guarantee"},
            ],
            chartTitle: "Service Request Volume",            chartData: [
              { value: 85 },
              { value: 70 },
              { value: 90 },
              { value: 75 },
            ...
            listTitle: "Recent Requests",            listItems: [
      ...
      <div id="social-proof" data-section="social-proof">
        <SocialProofOne
          ...
          useInvertedBackground={false}
          names={[
            "UAE Visa Authority",            "Dubai Business Services",            "Pro Services Networks",            "Corporate Legal Support",            "Government Services Hub",            "Business Registration Authority",            "Document Processing Centers",            "Professional Consultants"]}
          speed={40}
          showCard={true}
        />
      </div>
      ...
      <div id="reviews" data-section="reviews">
        <TestimonialCardSix
          ...
          testimonials={[
            {
              id: "1",              name: "Ahmed Al Mansouri",              handle: "Business Owner",              testimonial:
      ...
      <div id="cta" data-section="cta">
        <FeatureCardMedia
          ...
          features={[
            {
              id: "quick-start",              title: "Quick Start",              description: "Get professional assistance within 24 hours of your request",              tag: "Fast",              imageSrc: "http://img.b2bpic.net/free-photo/businessman-using-mobile-phone_107420-84785.jpg",              buttons: [{ text: "Contact Us", href: "/contact" }],
            },
            {
              id: "consultation",              title: "Free Consultation",              description: "Discuss your needs with our experts at no initial cost",              tag: "Free",              imageSrc: "http://img.b2bpic.net/free-photo/business-meeting-cafe_53876-15162.jpg",              buttons: [{ text: "Schedule Now", href: "/contact" }],
            },
          ]}
        />
      </div>
